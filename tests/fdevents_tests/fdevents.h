...
#define FDEVENT_EVENT_POLLIN		(FDEVENT_EVENT_POLLRDNORM | FDEVENT_EVENT_POLLRDBAND)
#define FDEVENT_EVENT_POLLNVAL		(1 << 2)
#define FDEVENT_EVENT_POLLOUT		FDEVENT_EVENT_POLLWRNORM
#define FDEVENT_EVENT_POLLPRI		(1 << 3)
#define FDEVENT_EVENT_POLLRDBAND	(1 << 4)
#define FDEVENT_EVENT_POLLRDNORM	(1 << 5)
#define FDEVENT_EVENT_POLLWRBAND	(1 << 6)
#define FDEVENT_EVENT_POLLWRNORM	(1 << 7)
