...
typedef void (*asyncio_fdevent_cb)(int fd, asyncio_fdevent_t revents, void *arg, asyncio_handle_t self_handle);
typedef void (*asyncio_timevent_cb)(void *arg, asyncio_handle_t self_handle);
...
int asyncio_continue(asyncio_handle_t handle);
